...
- generic desktop automation claims
- frontend execution controls
- frontend config editing
- frontend file write-back
- LLM-driven execution

## Release Candidate Quality Signals

- clearer repository opening path
- stronger read-only frontend landing and evidence browsing
- safer single-command validation path
- stronger repo health summary
- cleaner release-facing notes and summaries
